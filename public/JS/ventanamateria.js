document.addEventListener("DOMContentLoaded", () => {
    ...
    const modalCrear = document.getElementById("modal-materia");
    ...
    const formCrear = document.getElementById("form-materia");
...
const inputCodigoDelete = document.getElementById("codigoEli");
...
eliminarBtns.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    const fila = e.target.closest("tr"); 
    const codigoActual = fila.children[0].innerText;
    inputCodigoDelete.value = codigoActual; 
